...
import com.bengebackend.websocket.processor.AtmosphereMessageProcessor;
...
public class AtmosphereMessageHandler implements MessageHandler{

    private final SessionRegistry sessionRegistry;
    private final UserMapper userMapper;
    private final AtmosphereMessageProcessor atmosphereMessageProcessor;
    ...
    public void handleMessage(WebSocketSession session, WebSocketMessage message) {
        ...
        List<WebSocketMessage.AtmosphereNode> nodes = message.getAtmosphereNodes();
        List<WebSocketMessage.AtmosphereEdge> edges = message.getAtmosphereEdges();
        atmosphereMessageProcessor.processFullCanvasUpdate(session, roomId, userId, user, nodes, edges);
    }
}
